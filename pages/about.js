        ...
        <div className="row align-items-center">
          <div className="col-lg-6 order-2 order-lg-1">
            <p className="font-italic text-muted mb-4">
              ...
              <br/><br/>
              [EN] Today, almost 10 years after the first trip that would be the starting point of this adventure called Nanfuen, I can say that I have had the honor of working, studying, and sharing with two of the people I admire most in bonsai. I was able to work on trees for exhibitions, see trees evolve, start teaching, and begin a dream that I call Nanfuen.
            </p>
          </div>
        </div>
      </div>
