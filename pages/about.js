      ...
      <div className="py-5">
        ...
        <section>
          <div className="row align-items-center">
            <div className="col-lg-6 order-2 order-lg-1">
              ...
              <Image src="/images/Fuji_trip.jpg" className="rounded" width={300} height={200} alt="First trip to Japan" />
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 px-6 mx-auto">
              ...
              <div className="d-flex justify-content-end">
                <Image src="/images/Naming.jpg" className="rounded" width={330} height={200} alt="Naming ceremony" />
        ...
        <section>
          <div className="row align-items-center">
            <div className="col-lg-6 order-2 order-lg-1">
              ...
              <div className="d-flex">
                <Image src="/images/Oyakata_shipaku.jpg" className="rounded" width={300} height={200} alt="Oyakata Shipaku" />
              </div>
              <p className="font-italic text-muted mb-4">
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 px-6 mx-auto">
              <div className="d-flex justify-content-end">
                <Image src="/images/Cordoba_workshop_2.jpg" className="rounded" width={300} height={200} alt="Workshop in Cordoba" />
        ...
        <section>
          <div className="row align-items-center">
            <div className="col-lg-6 order-2 order-lg-1">
              ...
              <div className="d-flex">
                <Image src="/images/Oyakata_primer_minister.jpg" className="rounded" width={250} height={350} alt="Adapting to Change" />
              </div>
              <p className="font-italic text-muted mb-4">
        ...
        <section>
          <div className="row align-items-center">
            <div className="col-lg-6 px-6 mx-auto">
              ...
              <div className="d-flex justify-content-end">
                <Image src="/images/new_oyakata.png" className="rounded" width={300} height={400} alt="New Oyakata" />
